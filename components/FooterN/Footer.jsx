    ...
    <div className='FooterContent'>
      ...
      <div id="myModal" className="modal">
        <div className="modal-content">
          ...
          <p>+358 443745751</p>
          <br></br>
          <h2 className='modalSmallHeader'>3. REKISTERIN NIMI</h2>
          <p>Stipendirekisteri</p>
          <br></br>
          <h2 className='modalSmallHeader'>4. HENKILÖTIETOJEN KÄSITTELYN PERUSTE JA TARKOITUS</h2>
          ...
          <br></br>
          <h2 className='modalSmallHeader'>5. SÄÄNNÖNMUKAISET TIETOLÄHTEET</h2>
          ...
          <br></br>
          <h2 className='modalSmallHeader'>6. SÄÄNNÖNMUKAISET TIETOJEN LUOVUTUKSET</h2>
          <p>Stipendien saajien nimet ovat julkista tietoa.
	        Tietoja stipendin saamisesta ei toimiteta viranomaisille.
          </p>
          <h2 className='modalSmallHeader'>7. TIETOJEN SIIRTO EU:N TAI ETA:N ULKOPUOLELLE</h2>
          <p>Henkilötietoja ei siirretä EU:n tai Euroopan talousalueen ulkopuolelle.</p>
          <br></br>
          <h2 className='modalSmallHeader'>8. REKISTERIN SUOJAUKSEN PERIAATTEET</h2>
          ...
          <br></br>
          <h2 className='modalSmallHeader'>9. TARKASTUSOIKEUS JA OIKEUS VAATIA TIEDON KORJAAMISTA JA POISTAMISTA</h2>
          ...
          <br></br>
          <h2 className='modalSmallHeader'>10. MUUT HENKILÖTIETOJEN KÄSITTELYYN LIITTYVÄT OIKEUDET</h2>
